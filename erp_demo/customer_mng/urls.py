...
from erp_demo.customer_mng.views import IndexView, ListView, CreateView, ShowView, EditView, DeleteView

urlpatterns = [
    path('', IndexView.as_view(), name='customer mng index'),
    path('customer-list/', ListView.as_view(), name='customer list'),
    path('add-customer/', CreateView.as_view(), name='add customer'),
    path('show-customer/<int:pk>/<slug:slug>/', ShowView.as_view(), name='show customer'),
    path('edit-customer/<int:pk>/<slug:slug>/', EditView.as_view(), name='edit customer'),
    path('delete-customer/<int:pk>/<slug:slug>/', DeleteView.as_view(), name='delete customer'),
]

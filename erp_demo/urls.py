...
urlpatterns = [
    ...
    path('m21/', include('erp_demo.defect_cat_mng.urls')),
    path('m22/', include('erp_demo.statistics_mng.urls')),
    path('m23/', include('erp_demo.review_mng.urls')),
    path('m24/', include('erp_demo.analytics.urls')),

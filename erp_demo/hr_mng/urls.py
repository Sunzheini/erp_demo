...
urlpatterns = [
    ...
    path('show-employee/<int:pk>/<slug:slug>/', HrMngViews().show_employee, name='show employee'),
    ...
    path('training/', include([
        ...
        path('show-training/<int:pk>/<slug:slug>/', HrMngViews().show_training, name='show training'),
